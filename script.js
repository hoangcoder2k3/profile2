...
tabs.forEach((tab, index) => {
    ...
    tab.onclick = function () {
        ...
        document.querySelector('.container-wrapper-first').style.animation = 'slideRight 0.5s ease-in-out forwards';
        // setTimeout(() => {
...
closeButtons.forEach(button => {
    button.onclick = function () {
        document.querySelector('.container-wrapper-first').style.animation = 'slideLeft 0.5s ease-in-out';
